...
.. dragndrop:: matching_7
   ...
   :match_10: Gosper's Gun|||The number of live cells grows indefinitely as a stable pattern that periodically produces a spaceship — as the stream of spaceships moves out from the source.
