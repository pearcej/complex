...
The code for this chapter is in chap07.ipynb_ in the repository for this book. More information about working with the code is in Section :ref:`Section 1.4 <1.4>`.
